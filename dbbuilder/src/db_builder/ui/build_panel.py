...
class BuildWorker(QThread):
    ...
    def _process_one(self, file_id: int):
        ...
        try:
            ...
            self.db.insert_chunks_batch(chunk_dicts)
    ...
    def _run_embedding(self):
        pending_count = self.db.conn.execute(
        ...
        self.log.emit(f"Embedding {pending_count} chunk(s)...")
        ...
        try:
            ...
            stats = writer.get_collection_stats("manuals")
