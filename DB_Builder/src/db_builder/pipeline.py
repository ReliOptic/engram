...
class EmbeddingPipeline:
    ...
    def _write_to_chromadb(self) -> None:
        ...
        # Get embedded chunks that need to be written
        ...
        # Re-embed for ChromaDB write (we need the vectors)
        ...
        for row in rows:
            row_dict = dict(row)
            # We need to re-compute embedding for ChromaDB
            # This is done in batches below
